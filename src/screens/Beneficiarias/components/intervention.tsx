...
const beneficiarieServiceForm: React.FC = ({ route, localities, profiles, us, partners, subServices }:any) => {
                                ...
                                {({
                                    ...
                                    errors
                                        ...
                                        <FormControl isRequired isInvalid={'us_id' in errors}>
                                            <FormControl.Label>Servico</FormControl.Label>
                                            <Picker 
                                        ...
                                        <FormControl isRequired isInvalid={'surname' in errors}>
                                            ...
                                            <Picker 
                                                style={styles.dropDownPicker}
                                                selectedValue={values.surname}
                                                onValueChange={(itemValue, itemIndex) => { 
                                                        if (itemIndex !== 0){
                                                            setFieldValue('surname', itemValue);
                                                        }
                                                    }
                                                }>
                                                <Picker.Item label="-- Seleccione o Servico --" value="0" />

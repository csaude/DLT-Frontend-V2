...
const DadosReferenciaView: React.FC = ({ route }: any) => {
  const { reference, beneficiary, notify, organization } = route.params;
          ...
          <View style={styles.containerForm}>
            ...
            <Flex direction="column" mb="2.5" _text={{ color: "coolGray.800" }}>
              <Box bg="primary.500" p="2" rounded="lg">
                ...
                <Text style={styles.txtLabelInfo}>
                  {" "}
                  <Text style={styles.txtLabel}> Referente: </Text>{" "}
                  {referred_by}{" "}
                </Text>
                ...
                <Text style={styles.txtLabelInfo}>
                  {" "}
                  <Text style={styles.txtLabel}> Contacto: </Text>{" "}
                  {beneficiary?.phone_number}{" "}
                </Text>

                <Text style={styles.txtLabelInfo}>
                  {" "}
                  <Text style={styles.txtLabel}> No do Livro: </Text>{" "}
                ...
                <Text style={styles.txtLabelInfo}>
                  {" "}
                  <Text style={styles.txtLabel}> Cod. Referência: </Text>{" "}
                  {reference?.reference_code}{" "}
                </Text>

                <Text style={styles.txtLabelInfo}>
                  {" "}
                  <Text style={styles.txtLabel}> Tipo Serviço: </Text>

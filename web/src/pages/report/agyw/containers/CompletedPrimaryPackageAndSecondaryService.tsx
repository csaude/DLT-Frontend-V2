...
const CompletedPrimaryPackageAndSecondaryService = ({ districtId }) => {
  ...
  const total =
    responseData[districtId]["completed-primary-package-and-secondary-service"]
      .total;
  ...
  const arrTotals = Object.keys(completedPrimaryPackageAndSecondaryService).map(
    (key) => ({
      key,
  ...
  const title_pt =
    "Beneficiárias que completaram o pacote primário completo do DREAMS e pelo menos um serviço/intervenção secundário ";

...
import { Button, Card, Col, DatePicker, Form, Row, Select, Space, Typography, Image } from "antd";
	...
	return (
		<Fragment>
			...
			<Card>
				...
				<Title level={3} style={{ marginBottom: '10px', textAlign: "center", color: "#17a2b8" }} >
					PEPFAR MER 2.6.1 Indicador Semi-Annual AGYW_PREV
				</Title>
				<Card title="Pârametros do Indicador AGYW_PREV "
					bordered={false}

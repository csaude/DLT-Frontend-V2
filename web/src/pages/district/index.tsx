...
const DistrictList: React.FC = () => {
    ...
    const [districtModalVisible, setDistrictModalVisible] = useState<boolean>(false);
    ...
    return (
        <>
            ...
            <Card title="Lista de Distritos" bordered={false} headStyle={{ color: "#17a2b8" }}
                extra={
                    <Space>
                        <Button type="primary" icon={<PlusOutlined />} onClick={() => handleDistrictModalVisible(true)}>
                            Adicionar Distrito
                        </Button>
                    </Space>
                }
            ...
            <DistrictForm form={form} district={selectedDistrict} modalVisible={districtModalVisible} handleModalVisible={handleDistrictModalVisible} handleAdd={handleAdd} />
        </>
    );
}

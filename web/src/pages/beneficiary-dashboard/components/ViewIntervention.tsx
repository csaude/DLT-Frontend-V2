          ...
          >
            <Row gutter={8}>
              ...
              <Col
                ...
                span={12}
              >
                {record?.subServices?.service.serviceType == 0
                  ? "Serviços Clínicos"
            ...
            <Row gutter={8}>
              ...
              <Col className="gutter-row" span={12}>
                {record?.subServices?.service.name}
              </Col>
            </Row>
            <Row gutter={8}>
              <Col
            ...
            <Row gutter={8}>
              ...
              >
                {record?.dateUpdated !== null
                  ? moment(record?.dateUpdated).format("YYYY-MM-DD")
                  : ""}
              </Col>
            </Row>
          </Card>
...
export default ViewBenefiaryPanel;

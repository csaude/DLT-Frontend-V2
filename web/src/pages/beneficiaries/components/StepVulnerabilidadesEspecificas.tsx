      ...
      <Row gutter={24}>
        <Col className="gutter-row" span={8}>
          <Form.Item
            ...
            tooltip="Envolvimento simultâneo com mais de um parceiro sexual, aumentando o risco de infecções"
            rules={[{ required: true, message: RequiredFieldMessage }]}
            style={{ textAlign: "left" }}
        ...
        <Col className="gutter-row" span={8}>
          <Form.Item
            ...
            tooltip="Sujeita a abuso ou tráfico para fins de exploração sexual (sexo em troca de dinheiro e/ou favores com menores de 18 anos é sempre considerado exploração sexual)"
            rules={[{ required: true, message: RequiredFieldMessage }]}
            style={{ textAlign: "left" }}
      ...
      <Row gutter={24}>
        <Col className="gutter-row" span={8}>
          <Form.Item
            ...
            tooltip="Consumo de substâncias que podem impactar a saúde e o comportamento (10-17 anos é elegível a este critério se consumir álcool ou drogas uma vez por semana, 18-24 anos é elegível a este critério se consumir álcool ou drogas mais de quatro vezes por semana)"
            rules={[{ required: true, message: RequiredFieldMessage }]}
            style={{ textAlign: "left" }}
        ...
        <Col className="gutter-row" span={8}>
          <Form.Item
            ...
            tooltip="Registos anteriores de infecções sexualmente transmissíveis identificadas por um provedor de saúde na US"
            rules={[{ required: true, message: RequiredFieldMessage }]}
            style={{ textAlign: "left" }}
        ...
        <Col className="gutter-row" span={8} hidden={minAge}>
          <Form.Item
            ...
            tooltip="Pessoa que oferece serviços sexuais em troca de favores ou dinheiro"
            style={{ textAlign: "left" }}

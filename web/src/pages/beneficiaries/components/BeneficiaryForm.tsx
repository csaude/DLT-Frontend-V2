        ...
        <Form form={form} layout="vertical">
          <Tabs>
            <Tabs.TabPane tab="Dados Pessoais" key="1">
                  ...
                  <Row>
                    ...
                    <Col span={13}>
                      ...
                      >
                        {" "}
                        <span
                          style={{ color: "#008d4c", fontWeight: "normal" }}
                        >
              ...
              <Row gutter={16}>
                <Col className="gutter-row" span={12}>
                  <Form.Item name="schoolName" label="Alcunha">
                    <Input placeholder="Insira a alcunha" />
                  </Form.Item>
                </Col>
                <Col className="gutter-row" span={12}>
                  <Form.Item name="address" label="Morada(Bairro)">
              ...
              <Row gutter={16}>
                <Col className="gutter-row" span={12}>
                  <Form.Item name="phoneNumber" label="Telemóvel">

...
const UsForm = ({ form, us, modalVisible, handleModalVisible, handleAdd }) => {
    ...
    const fetchLocality = (district_id) => {     
        let localitiesByDistrict = locality.filter(item=>{
            ...
            <Form form={form} layout="vertical">
                 <Row gutter={12}>
                    <Col className="gutter-row" span={7}>
                        <Form.Item
                            ...
                            initialValue={us === undefined ? "" : us?.locality?.district?.province?.id.toString()}
                        >
                    ...
                    <Col className="gutter-row" span={7}>
                        <Form.Item
                            ...
                            label="Distrito"
                            rules={[{ required: true, message: 'Obrigatório' }]}
                            initialValue={us === undefined ? "" : us?.locality?.district?.id.toString()}
                        >
                            <Select placeholder="Seleccione o Distrito" onChange={handleOnChangeDistrict}>
                ...
                <Row gutter={12}>
                     <Col span={14}>
                        ...
                        >
                            <TextArea rows={4} placeholder="Insira a descrição da Organização"  maxLength={6}  />
                        </Form.Item>
                    </Col>
